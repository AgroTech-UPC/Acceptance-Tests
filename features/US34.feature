Feature: US32 Uso de nuestra API para gestionar recursos y gastos
    Como desarrollador
    quiero integrar un API
    para gestionar la información de los recursos y gastos de los criadores en la base de datos, de manera que pueda 
